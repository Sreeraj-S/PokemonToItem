...
const translations = {
  strings: {
    ...
    "The announcement was ended by ${user.name}.": "De mededeling is be\xEBindigd door ${user.name}.",
    ...
    "The poll was ended by ${user.name}.": "${user.name} heeft de poll be\xEBindigd.",
