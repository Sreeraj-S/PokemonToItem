...
const translations = {
  strings: {
    ...
    "User ${targetUsername} not found. Did you misspell their name?": "Usuario ${targetUsername} no encontrado. \xBFLo escribiste mal?",
    "User ${targetUsername} is offline.": "El usuario ${targetUsername} est\xE1 desconectado.",
    ...
    'This user is already in "${targetRoom.title}".': 'Este usuario ya est\xE1 en la sala "${targetRoom.title}".',
    ...
    "${targetUser.name} has not requested extraction.": "El usuario ${targetUser.name} no ha solicitado una extracci\xF3n",
    "You have already consented to extraction with ${targetUser.name}.": "T\xFA ya has dado consentimiento para la extracci\xF3n con ${targetUser.name}.",
    ...
    "${targetUser.name} has extracted the battle input log.": "${targetUser.name} ha extra\xEDdo el registro de mensajes de la batalla.",
    ...
    "${user.name} has extracted the battle input log.": "${user.name} ha extra\xEDdo el registro de mensajes de la batalla.",
    ...
    "${user.name} is offering a tie.": "${user.name} est\xE1 ofreciendo un empate.",
    ...
    "${user.name} accepted the tie.": "${user.name} acept\xF3 el empate.",
    ...
    "${user.name} rejected the tie.": "${user.name} rechaz\xF3 el empate.",
    ...
    "${user.name} hid the replay of this battle.": "${user.name} ocult\xF3 la repetici\xF3n de esta batalla.",
    ...
    "The game timer is ON (requested by ${requester})": "El temporizador del juego est\xE1 ENCENDIDO (solicitado por ${requester}",
    ...
    "Forcetimer is now OFF: The timer is now opt-in. (set by ${user.name})": "Forcetimer ahora est\xE1 APAGADO: El temporizador est\xE1 habilitado ahora. (colocado por ${user.name})",
    "Forcetimer is now ON: All battles will be timed. (set by ${user.name})": "Forcetimer ahora est\xE1 ENCENDIDO: Todas las batallas tendr\xE1n temporizador. (colocado por ${user.name})",
    ...
    "Could not find help for '/${target}' - displaying help for '/${closestHelp}' instead": "No se encontr\xF3 ayuda para '/${target}' - mostrando ayuda para '/${closestHelp}' en su lugar"
  }
};
